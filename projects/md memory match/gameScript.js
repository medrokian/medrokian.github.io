var em = ["uzi.jpg", "uzidad.jpg", "v.jpg", "thad.jpg", "tessa.jpg", "nori.jpg", "n.jpg", "uzi.jpg", "uzidad.jpg", "v.jpg", "thad.jpg", "tessa.jpg", "nori.jpg", "n.jpg"];
...
function start(r, l) {
    ...
    for (var i = 1; i <= r; i++) {
        $("table").append("<tr>");
        for (var j = 1; j <= l; j++) {
            $("table").append(`<td id='${n}' onclick="change(${n})"><div class='inner'><div class='front'></div><div class='back'><img src="${items[n - 1]}" alt="Card Image"></div></div></td>`);
            n++;
        }
        $("table").append("</tr>");
    }
